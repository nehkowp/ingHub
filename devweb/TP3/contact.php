...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Dans un environnement réel, envoi du mail
        // mail('webmaster@lafleur.fr', 'Contact site Lafleur : ' . $formData['sujet'], $message);
...
<head>
    ...
    <title>Société Lafleur - Contact</title>
                ...
                <form action="contact.php" method="post" class="contact-form" id="contact-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <select id="fonction" name="fonction" class="<?php echo isset($errors['fonction']) ? 'error-field' : ''; ?>" required>
                            <option value="" <?php echo empty($formData['fonction']) ? 'selected' : ''; ?>>Sélectionnez une fonction</option>
                            <option value="particulier" <?php echo $formData['fonction'] === 'particulier' ? 'selected' : ''; ?>>Particulier</option>
                            <option value="paysagiste" <?php echo $formData['fonction'] === 'paysagiste' ? 'selected' : ''; ?>>Paysagiste</option>
                            <option value="collectivite" <?php echo $formData['fonction'] === 'collectivite' ? 'selected' : ''; ?>>Collectivité locale</option>
                            <option value="entreprise" <?php echo $formData['fonction'] === 'entreprise' ? 'selected' : ''; ?>>Entreprise</option>
