...
<head>
    ...
    <title>NBAConnect - <?php echo htmlspecialchars($categorieInfo['nom']); ?></title>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="quantity-cell">
                                ...
                                <button class="quantity-btn quantity-btn minus-btnplus-btn" 
                                ...
                                <button class="add-to-cart-btn"
                                    ...
                                    disabled><i class="fas fa-cart-plus"></i> RECRUTER</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
