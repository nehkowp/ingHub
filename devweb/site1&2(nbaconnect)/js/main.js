// Initialiser les stocks pour chaque joueur
const stocks = {
    // Meneurs
    'm01': 10,
    'm02': 8,
    ...
    tables.forEach(table => {
        ...
        rows.forEach(row => {
            ...
            if (refCell) {
                ...
                addToCartBtn.innerHTML = 'Recruter <i class="fas fa-user-plus"></i>';
        ...
        stockBtn.textContent = 'Afficher les disponibilités';
        ...
        stockBtn.addEventListener('click', () => {
            ...
            stockBtn.textContent = isHidden ? 'Cacher les disponibilités' : 'Afficher les disponibilités';
        });
...
function setupImageZoom() {
    ...
    productImages.forEach(img => {
        ...
        img.addEventListener('click', () => {
            ...
            zoomedImg.style.border = '3px solid var(--primary)';
